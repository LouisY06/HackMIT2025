...
import { ArrowBack, Google, Store, AttachMoney, Nature, Groups, Star } from '@mui/icons-material';
...
const StoreLogin: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (user) {
        const profileResponse = await fetch(`${API_BASE_URL}/api/users/check-profile/store/${user.uid}`);
  ...
  const handleEmailAuth = async () => {
    ...
    try {
      if (isSignIn) {
        ...
        try {
          const emailCheckResponse = await fetch(`${API_BASE_URL}/api/users/check-email/store/${email}`);
      ...
      <Container maxWidth="md" sx={{ mt: 8 }}>
        ...
        >
          ...
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              Reduce waste costs and help community. List surplus food for pickup and track your impact.
            </Typography>
            ...
            >
              <Box sx={{ textAlign: 'center' }}>
                <AttachMoney sx={{ fontSize: 32, mb: 1, color: '#7A8B5C' }} />
                <Typography variant="body2" sx={{ fontWeight: 300 }}>
                  Save Costs
                </Typography>
              </Box>
              <Box sx={{ textAlign: 'center' }}>
                <Nature sx={{ fontSize: 32, mb: 1, color: '#7A8B5C' }} />
                <Typography variant="body2" sx={{ fontWeight: 300 }}>
                  Sustainability
                </Typography>
              </Box>
              <Box sx={{ textAlign: 'center' }}>
                <Groups sx={{ fontSize: 32, mb: 1, color: '#7A8B5C' }} />
                <Typography variant="body2" sx={{ fontWeight: 300 }}>
                  Help Community
                </Typography>
              </Box>
              <Box sx={{ textAlign: 'center' }}>
                <Star sx={{ fontSize: 32, mb: 1, color: '#7A8B5C' }} />
                <Typography variant="body2" sx={{ fontWeight: 300 }}>
                  Brand Reputation
                </Typography>
              </Box>
          ...
          >
            <CardContent sx={{ p: 6 }}>
              ...
              >
                {isSignIn ? 'Sign in to your store account' : 'Create your store account'}
              </Typography>
